    ...
    return (
      <div className="page">
        <div className="container">
          <h1 className="heading">admit kard</h1>
          <div className="tel-box">
            ...
            <input type="tel" placeholder="9999999999" className="tel" onChange={this.phoneHandler} defaultValue={this.state.phone} />
          </div>
          <div className="output">
    <h2>Phone no.:</h2> <span className="result">+{this.state.countryCodeValue}{this.state.phone}</span>
          </div>
        </div>
      </div>
    );
